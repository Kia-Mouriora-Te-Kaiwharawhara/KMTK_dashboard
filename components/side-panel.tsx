...
export function SidePanel({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:relative left-0 top-0 h-full lg:h-auto bg-primary border-r border-deep-brown rounded-sm z-40 transition-all duration-300 ease-in-out transform ${
