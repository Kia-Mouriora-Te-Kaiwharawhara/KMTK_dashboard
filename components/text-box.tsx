...
function TextBox({
  ...
  ...props
    ...
    if (type == null) {
        return (
            <div className={cn(`w-9/10 bg-primary text-center p-5 h-auto my-3 sm:flex-wrap`, className)} {...props}>
        ...
        return (
            <div
                className={cn(`w-9/10 bg-deep-brown text-center flex-row p-6 h-auto my-3 sm:flex-wrap`, className)} {...props}>
        ...
        return (
            <div
                className={cn(` w-auto inline-flex bg-deep-brown text-center flex-row p-6 h-auto my-3 sm:flex-wrap`, className)} {...props}>
        ...
        return (
            <div
                className={cn(`w-fit bg-primary text-left h-auto my-3 p-6 sm:flex-wrap`, className)} {...props}>
                {secondaryText && <h1 className={cn("text-4xl text-center text-deep-brown mr-3")}>{secondaryText}</h1>}
